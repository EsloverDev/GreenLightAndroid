...
import com.example.greenlightproject.BuildConfig;
...
public class UbicacionesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        puntos.add(new OverlayItem("GreenLight", "Sede Centro", Centro));
        puntos.add(new OverlayItem("GreenLight", "Sede Kennedy", Kennedy));
        puntos.add(new OverlayItem("GreenLight","Sede Chicó", Chico));
        refrescaPuntos();
